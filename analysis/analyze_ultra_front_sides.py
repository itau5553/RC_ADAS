...
#
# Usage example:
#   python "C:\Users\imran\Desktop\thesis\python script\analysis3\analyze_ultra_front_sides.py" "C:\Users\imran\Desktop\thesis\testing results\ultrasonic_servo_front_right_obstacle.txt"--outdir "C:\Users\imran\Desktop\thesis\python script\analysis3\analysis_out" --threshold 60 --verbose --title "Ultrasonic signal vs servo actuation (Right side Blocked)
#python "C:\Users\imran\Desktop\thesis\python script\analysis3\analyze_ultra_front_sides.py" "C:\Users\imran\Desktop\thesis\testing results\ultrasonic_servo_front_left_obstacle.txt"--outdir "C:\Users\imran\Desktop\thesis\python script\analysis3\analysis_out" --threshold 60 --verbose --title "Ultrasonic signal vs servo actuation (Left side Blocked)"  
#
...
def plot_timeseries(df: pd.DataFrame, phases: List, out_png: str,
                    title: str, threshold: float = 60.0, side_threshold: float = 20.0):
    if df.empty:
    ...
    # Add side-clearance threshold (grey dotted)
    ax1.axhline(y=side_threshold, color='gray', linestyle=':', linewidth=1.5,
                label=f'Side threshold = {side_threshold} cm')
...
def main():
    ...
    plot_timeseries(df, phases, out_png, title=args.title,
                threshold=args.threshold, side_threshold=args.side_threshold)
