...
#
# Usage example:
#   python "C:\path\analyze_ultra_front_sides.py" "C:\path\ultrasonic_servo_front_right_obstacle.txt"--outdir "C:\path\analysis_out" --threshold 60 --verbose --title "Ultrasonic signal vs servo actuation (Right side Blocked)
#python "C:\path\analyze_ultra_front_sides.py" "C:\path\ultrasonic_servo_front_left_obstacle.txt"--outdir "C:\path\analysis_out" --threshold 60 --verbose --title "Ultrasonic signal vs servo actuation (Left side Blocked)"  
#
